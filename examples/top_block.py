...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.max_sample_rate = max_sample_rate = 500e6
        self.gain = gain = 80
        ...
        # Blocks
        ##################################################
        self._samp_rate_range = Range(1e6, max_sample_rate, 1e6, 20e6, 200)
        ...
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._frequency_range = Range(100e6, 6000e6, 1e6, 1000e6, 200)
        ...
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._bandwidth_range = Range(.1e6, max_sample_rate, 0.1e6, 20e6, 200)
        ...
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.sidekiq_rx_0 = sidekiq.sidekiq_rx(0, 0, 100, samp_rate, gain, 0, frequency, bandwidth, 1 )
